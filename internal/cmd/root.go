...
import (
	...
	"github.com/builtbyrobben/dataforseo-cli/internal/errfmt"
...
type CLI struct {
	...
	Keywords   KeywordsCmd      `cmd:"" help:"Keyword research"`
	Labs       LabsCmd          `cmd:"" help:"DataForSEO Labs"`
	Serp       SerpCmd          `cmd:"" help:"SERP analysis"`
...
func newParser(description string) (*kong.Kong, *CLI, error) {
	envMode := outfmt.FromEnv("DATAFORSEO_CLI")
	vars := kong.Vars{
		"color":   envOr("DATAFORSEO_CLI_COLOR", "auto"),
...
func helpDescription() string {
	return "DataForSEO CLI - SEO data from the command line"
}
